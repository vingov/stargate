 ...
 *
 */
$drupal_hash_salt = '2sUAG2e6H-0L_DAc75sGAtDFhj5KYdx_Tug5FsiupiY';
...
/**
 * Configured acquia purge to use the https domain instead of http domain
 */
...
$conf['acquia_deploy_git_config'] = array(
  'pull' => array(
    array(
      'uri' => 'https://github.com/CBNewMedia/uwe_drupal_7.git',
      'branch' => 'master',
      'src_dir' => '/',
      'dest_dir' => '/docroot',
    ),
    array(
      'uri' => 'https://github.com/vinothgovindarajan/stargate.git',
      'branch' => 'master',
      'src_dir' => '/',
  ...
  'push' => array(
    'uri' => 'stargate@svn-4558.devcloud.hosting.acquia.com:stargate.git',
    'branch' => 'master',
  ),
);
...
switch ($env) {
  ...
  case 'local':
    ...
    $conf['acquia_deploy_git_config']['pull'][0]['branch'] = 'dev1';
    $conf['acquia_deploy_git_config']['pull'][1]['branch'] = 'dev1';
    $conf['acquia_deploy_git_config']['push']['branch'] = 'dev1';
  ...
  case 'stage':
    ...
    // Override domain detection in Acquia Purge.
    $conf['acquia_purge_domains'] = array(
      'wwwstg.collegeboard.org',
      'cbuwstg.collegeboard.org',
    );
    break;
...
// As $_SERVER['HTTP_HOST'] is user input, ensure it only contains characters allowed in hostnames.
$base_url = $base_root .'://'. preg_replace('/[^a-zA-Z0-9-:._]/i', '', $_SERVER['HTTP_HOST']);
...
// Configure an email address here to send email alerts when someone attempts to login as User 1.
$conf['cb_login_alert_email'] = 'HomeOrgDrupalSupport@collegeboard.org';
